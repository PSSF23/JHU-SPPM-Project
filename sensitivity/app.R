          ...
          tabItem(tabName = "description",
                  ...
                  fluidRow(column(10,
                      ...
                      compartment"),
                                  ...
                                  h4("For 3C model, 15 parameters include", em("baseline tumor burden, albumin concentration, estimated glomerular 
                                  ...
                                  h4("For the global sensitivity analysis 3C, again we picked the the same parameters as 2C model:",
                                     em("albumin concentration"),
                                     "and",
                                     em("weight.")),
...
# =====================================================================================================================
          tabItem(tabName = "heatmaps", icon = 'dashboard',
                  box(title = "Introduction",width = 12, solidHeader = TRUE, status = "warning",
...
## ==============================================================================================================          
   #Global Sensitivity - 2compartment       
          tabItem(tabName = "glo_para",
                  box(title = "Introduction", width = 12,solidHeader = TRUE,status = "warning",
                      h4("We picked the two parameters with relative high senstivity:",
                         em("albumin concentration"),
                         "and",
                         em("weight."), 
                         "This is for conducting the sensitivity analysis with wide range of albumin and weight."),
                      br(),
                      h4("Select the dosing method you would like to investigate and then select which output to display", 
...
##=============================================================================================
     tabItem(tabName = "local3c", icon = 'dashboard',
             box(title = "Introduction",width = 12, solidHeader = TRUE, status = "warning",
                 h4("We have conducted sensitivity analysis for the same 5 different dosing methods."),
                 h4("For 3C model, 15 parameters include", em("baseline tumor burden, 
...
##==================================================================================================
    ...
    output$localSensPlot1 <- renderPlotly({
      ...
      localSensPlot1 <- ggplot(data = AUC4W_filtered, aes(x = Dosing, y = Parameter, fill = Sens)) +
        ...
        labs(title = 'Local Sensitivity of AUC in Blood, 4 weeks',
             x = "Dosing Methods") +
        heatmap_theme
    ...
    localSensPlot2 <- ggplot(data = AUC12W_filtered, aes(x = Dosing, y = Parameter, fill = Sens)) +
      ...
      labs(title = 'Local Sensitivity of AUC in Blood, 12 weeks',
           x = "Dosing Methods") +
      heatmap_theme
      # Convert ggplot to Plotly plot
   ...
   output$localSensPlot3 <- renderPlotly({
     ...
     localSensPlot3 <- ggplot(data = Cmax_filtered, aes(x = Dosing, y = Parameter, fill = Sens)) +
       ...
       labs(title = 'Local Sensitivity of Cmax in Blood, 12 weeks',
            x = "Dosing Methods") +
       heatmap_theme
     # Convert ggplot to Plotly plot
  ...
  #### ===============================================================================
   ...
   output$globe <- renderPlotly({
     ...
     globe <- ggplot(data = Globe_filtered, aes(x = Albumin, y = Weight, fill = Sens)) +
       geom_tile() +
       scale_fill_distiller(name = 'Output', palette = 'YlGnBu', 
