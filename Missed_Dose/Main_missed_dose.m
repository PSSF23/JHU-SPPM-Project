...
for dosing_method = 1:5
    ...
    save(strcat('data/2C/Missed_2C_',dose_name,'.mat'),'AUC_miss','Cmax_miss','Ctrough_miss');
    save(strcat('data/2C/Full_2C_',dose_name,'.mat'),'AUC_full','Cmax_full','Ctrough_full');
    close(WAIT)
end
...
for dosing_method = 1:5
    ...
    save(strcat('data/2C/Retake_2C_',dose_name,'.mat'),'AUC_retake','Cmax_retake','Ctrough_retake');
end
...
for dosing_method = 1:5
    ...
    save(strcat('data/3C/Missed_3C_',dose_name,'.mat'),'AUC_miss','Cmax_miss','Ctrough_miss',...
        'Tumor_ratio_miss','Dcomplex_min_miss');
    save(strcat('data/3C/Full_3C_',dose_name,'.mat'),'AUC_full','Cmax_full','Ctrough_full',...
...
for dosing_method = 1:5
    ...
    save(strcat('data/3C/Retake_3C_',dose_name,'.mat'),'AUC_retake','Cmax_retake','Ctrough_retake',...
