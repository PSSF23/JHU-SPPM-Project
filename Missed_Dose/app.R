...
retake_3C <- process_data_retake_3C(list(
  retake_3C_2mg_Q3W, retake_3C_10mg_Q3W, retake_3C_10mg_Q2W,
  retake_3C_200mg_Q3W, retake_3C_400mg_Q6W
), dosing_tag, retake_tag)
...
sidebar <-
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Missed Dose 2C Results",
        tabName = "2C_result", icon = icon("dashboard"),
        menuSubItem("Typical Concentration-Time Profile", tabName = "2C_typical"),
        menuSubItem("Population Variation", tabName = "2C_pop")
      ),
      menuItem("Missed Dose 3C Reults",
        tabName = "3C_result", icon = icon("dashboard"),
...
server <- function(input, output) {
  ...
  output$"2C_Ctrough" <- renderPlotly({
    ...
    plot_Ctrough_2C <- plot_Ctrough_2C %>%
      plotly_build() %>%
      layout(
        yaxis = list(title = list(
          text = "Ctrough (mg/L)",
  ...
  output$"3C_Ctrough" <- renderPlotly({
    ...
    plot_Ctrough_3C <- plot_Ctrough_3C %>%
      plotly_build() %>%
      layout(
        yaxis = list(title = list(
          text = "Ctrough (mg/L)",
