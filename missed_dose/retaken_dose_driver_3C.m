function [AUC, Cmax, Ctrough,Tumor_ratio,Dcomplex_min, T, Y] = retaken_dose_driver_3C(p,TimeLen,Interval,fixed, dose, retake_time)
...
for i = 1:NumDose
    ...
    elseif retake_time==Interval && i==2
        y0 = Y(end,:)+[2*q/p.v1 0 0 0 0 0 0 0 0];
    else
