...
p.gamma = 2.28;%2.28; % Drug effect term
...
for i = 1:NumberOfPatients/2 
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_weight(i) = PatientParam_2C(p);%Update Patient PK parameters.
end
%500 Female 
for i = (NumberOfPatients/2+1): NumberOfPatients
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_weight(i) = PatientParam_2C(p);
end
...
for i = 1:NumberOfPatients/2 
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_ALB(i) = PatientParam_2C(p);%Update Patient PK parameters.
end
%500 Female 
for i = (NumberOfPatients/2+1): NumberOfPatients
    p.sex = 2;
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_ALB(i) = PatientParam_2C(p);
end
...
for i = 1:NumberOfPatients/2 
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_weight_ALB(i) = PatientParam_2C(p);%Update Patient PK parameters.
end
%500 Female 
for i = (NumberOfPatients/2+1): NumberOfPatients
    p.sex = 2;
    ...
    p.eGFR = 88.47;
    p.BSLD = 89.6;
    patient_weight_ALB(i) = PatientParam_2C(p);
end

%% Save data
save('Patients_2C.mat', 'patient_ALB','patient_weight', 'patient_weight_ALB');