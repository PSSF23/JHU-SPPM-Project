...
#Combine data
Q3W_10<-cbind(Q3W_10_raw,Dose = rep.int("Q3W_10mg",times=nrow(Q3W_10_raw)))
Q3W_2<-cbind(Q3W_2_raw,Dose = rep.int("Q3W_2mg",times=nrow(Q3W_2_raw)))
Q2W_10<-cbind(Q2W_10_raw,Dose = rep.int("Q2W_10mg",times=nrow(Q2W_10_raw)))
...
Data_all<-rbind(Data_all,c(0,0,0,0,"Q3W_10mg"),c(0,0,0,0,"Q3W_2mg"),c(0,0,0,0,"Q2W_10mg"))
...
Plot1<-ggplot(data = NULL)+
  geom_line(data = Data_all,aes(x = Time,y = V1,color = Dose,linetype = Dose),size = 1.3)+
  #scale_color_brewer(name = '', palette = 'Dark2')+
  scale_y_continuous(trans='log10',limits = c(5,500),
                     breaks = c(5,10,20,50,100,200,500))+
  theme1+
  labs(title = "Typical Pembrolizumab Concentration-time Profile",
