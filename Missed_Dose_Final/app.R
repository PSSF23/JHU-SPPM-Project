...
body<-
  ...
  tabItem(tabName = 'description',
          fluidRow(column(
            ...
            tags$h3("In this analysis, pembrolizumab is prescribed to random simulated patients to analyze
            ...
            tags$h3("Pembrolizumab is a monoclonal IgG antibody that binds with PD-1 receptors,",
            ...
            h3(tags$p("We selected 5 dosing regimens. 3 are weight-based dosing selected from",
            ...
            h3(tags$p("Two models are used. The 2 compartmental PK model is adapted from the paper
                   ",
            ...
            tags$ul(
                      tags$li(" Area under curve of pembrolizumab concentration in central compartment over 12
                    weeks (12W AUC); ",
